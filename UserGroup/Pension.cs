...

{
    ...
    int count = 5;
    public static List<double> weights = new List<double>() { 2, 1, 1, 2, 0, 1, 0, 2, 1.5, 0, 2, 0, 0 };
    public List<double> Rankings = new List<double>();

    public Pension(UserLocation userLocation, RatingResponse ratingResponse)
    {
        LoadInfoFromDB();
        ...
        var nearestDoctors = LocationFinder.FindNearestDoctors(userLocation.Latitude, userLocation.Longitude, doctors, 8);
        ...
        ratingResponse.SaveRating("rente", nearestBibliotheks, nearestClinic, nearestParkings, nearestDoctors, nearestKindergartens, nearestMuseums, nearestMusicSchools, nearestParks, nearestPoliceStations, nearestPools, nearestStops, nearestSchools, nearestUniversities);
