...

{
    ...
    int count = 5;
    public static List<double> weights = new List<double>() { 1, 0.5, 0, 1, 1, 1, 0.5, 1.5, 1, 1, 2, 0.5, 0.5 };
    public List<double> Rankings = new List<double>();

    public YoungCouple(UserLocation userLocation, RatingResponse ratingResponse)
    {
        LoadInfoFromDB();
        ...
        var nearestKindergartens = LocationFinder.FindNearestKindergartens(userLocation.Latitude, userLocation.Longitude, kindergardens, 3);
        ...
        ratingResponse.SaveRating("couple", nearestBibliotheks, nearestClinic, nearestParkings, nearestDoctors, nearestKindergartens, nearestMuseums, nearestMusicSchools, nearestParks, nearestPoliceStations, nearestPools, nearestStops, nearestSchools, nearestUniversities);
